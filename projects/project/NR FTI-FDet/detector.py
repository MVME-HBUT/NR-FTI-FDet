...
from detectron2.layers import ShapeSpec,batched_nms,batched_nms_rotated
    ...
    def inference(self, _box_cls, _box_pred, image_sizes):
        ...
        for i, (scores_per_image, box_pred_per_image, image_size) in enumerate(zip(
            ...
            if self.nms:
                ...
                #     scores_per_image, 
                #     labels_per_image, 
                #     0.5) #0.5->0.97 for ablation
                    
                # keep = torchvision.ops.nms(box_pred_per_image, 
                #     scores_per_image, 
                #     0.5) #0.5->0.97 for ablation
                keep = zy_nms(box_pred_per_image, 
                    scores_per_image, 
                    0.5) #0.5->0.97 for ablation       
